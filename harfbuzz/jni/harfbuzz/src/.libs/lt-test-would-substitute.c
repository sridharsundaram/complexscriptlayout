...
/* ./.libs/lt-test-would-substitute.c - temporary wrapper executable for .libs/test-would-substitute.exe
   Generated by libtool (GNU libtool) 2.4

   The test-would-substitute program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "e:\\users\\sridhar\\git\\harfbuzz\\harfbuzz\\jni\\harfbuzz\\src\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "e:\\users\\sridhar\\git\\harfbuzz\\harfbuzz\\jni\\harfbuzz\\src\\.libs;C:\\MinGW\\msys\\1.0\\local\\lib;C:\\MinGW\\msys\\1.0\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "test-would-substitute.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test-would-substitute - temporary wrapper script for .libs/test-would-substitute.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The test-would-substitute program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libharfbuzz.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"test-would-substitute.exe:test-would-substitute:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-would-substitute.exe:test-would-substitute:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-would-substitute.exe:test-would-substitute:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test-would-substitute.exe'\n", f);
  ...
  fputs ("    PATH=/e/users/sridhar/git/harfbuzz/harfbuzz/jni/harfbuzz/src/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/e/users/sridhar/git/harfbuzz/harfbuzz/jni/harfbuzz/src/.libs:$PATH\"\n", f);
  fputs ("\n", f);
