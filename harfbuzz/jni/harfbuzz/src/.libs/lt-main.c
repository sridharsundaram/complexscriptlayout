...
/* ./.libs/lt-main.c - temporary wrapper executable for .libs/main.exe
...
const char * TARGET_PROGRAM_NAME = "main.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# main - temporary wrapper script for .libs/main.exe\n", f);
  ...
  fputs ("    echo \"main.exe:main:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"main.exe:main:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"main.exe:main:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
