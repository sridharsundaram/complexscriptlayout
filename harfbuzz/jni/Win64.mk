...
complex_script_layout: complex_script_layout_win.c
	...
	gcc -Wall -m64 -c -D_JNI_IMPLEMENTATION_ -Wl,--kill-at -I"C:/Program Files/Java/jdk1.8.0_111/include" -I"C:/Program Files/Java/jdk1.8.0_111/include/win32" -I"C:/Users/Sridhar/git/complexscriptlayout/harfbuzz/jni/harfbuzz/src" -I"C:/users/sridhar/git/complexscriptlayout/harfbuzz/jni/freetype/include"  complex_script_layout_win.c
	g++ -static -m64 -Wl,-subsystem,windows -shared -o complex_script_layout64.dll freetype/*.o harfbuzz/*.o complex_script_layout_win.o
